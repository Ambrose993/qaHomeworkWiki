...
describe("Employee Manager 1.2", () => {
    ...
    describe("handles error messages correctly", () => {
        ...
        test("lets you cancel out of an error message", async () => { //why does the async have a empty () 
            /*
            This test follows these steps:
            1. Open Bernice Ortiz
            2. Clear the name input
            ...
            */
            await driver.findElement(bernice).click(); //why does the click have an empty ()?
            await driver.wait(
                until.elementIsVisible(await driver.findElement(nameInput))
            );
            await driver.findElement(nameInput).clear();
...
//why do some commands need to have the () filled but others don't like clear or getText or click?
//what does => mean?
//in what circumstances do we use await vs expect?
// what can I do to get comfortable writing the script faster?
